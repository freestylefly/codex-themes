<div align="center">
  ...
  <p>
    <img alt="Version" src="https://img.shields.io/badge/version-v0.2.1-E8B04B?style=flat-square" />
...
当前公开版本为 **v0.2.1 Beta**，支持 Apple 芯片 Mac（M1–M4）。

- [下载 DMG 安装包](https://github.com/freestylefly/codex-themes/releases/download/v0.2.1/Codex-Themes-0.2.1-mac-arm64.dmg)
- [下载 ZIP 便携包](https://github.com/freestylefly/codex-themes/releases/download/v0.2.1/Codex-Themes-0.2.1-mac-arm64.zip)
